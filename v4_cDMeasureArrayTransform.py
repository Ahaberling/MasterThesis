                    ...
                    for swallowed_community in swallowed_communities:
                        ...
                        while community_death == False:                    # [288465877, 287698910, 286963357, 289531190]
                            ...
                            if len(members) != 0:
                                ...
                                all_id_in_next_window = [item for sublist in cd_topD['window_{0}'.format(j*30)] for item in sublist]
                        ...
                        swallowed_community.append(j)   # THIS IS THE ROW WHERE THE BLANKS NEED TO START (THIS ROW INCLUDED)
