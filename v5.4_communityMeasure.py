...
### NEW FILE cDMeasureArrayTransform #########
                ...
                if len(swallowed_communities) != 0:
                    ...
                    for swallowed_community in swallowed_communities:
                        ...
                        while community_death == False:  # [288465877, 287698910, 286963357, 289531190]
                            ...
                            all_id_in_next_window = [item for sublist in cd_topD['window_{0}'.format((j + 1) * 30)] for
                                                     item in sublist]
    ...
    print(kclique_topD_dic['window_900'])
    ...
    lp_recombination_diffusion_crip_count_v2, lp_recombination_diffusion_crip_fraction_v2, lp_recombination_diffusion_crip_threshold_v2 = recombination_diffusion_crip_v2(
        lp_topD_dic_clean, lp_recombinations)
    '''
    print(gm_recombinations['window_{0}'.format(63 * 30)])              # imported
    print(gm_topD_dic_clean['window_{0}'.format(63 * 30)])              # made here
    print(gm_topD_dic_cleanIndex['window_{0}'.format(63 * 30)])         # made here
    print(gm_topD_dic['window_{0}'.format(63 * 30)])                    # imported
    print(gm_topD['window_{0}'.format(62 * 30)])                    # imported
    print(gm_topD['window_{0}'.format(63 * 30)])                    # imported
    print(gm_topD['window_{0}'.format(64 * 30)])                    # imported
    print(gm_labeled['window_{0}'.format(62 * 30)])                    # imported
    print(gm_labeled['window_{0}'.format(63 * 30)])                    # imported
    print(gm_labeled['window_{0}'.format(64 * 30)])                    # imported
    '''
    # print(lp_recombinations)
    # print(gm_recombinations)

    print(1 + 1)
    gm_recombination_diffusion_crip_count_v2, gm_recombination_diffusion_crip_fraction_v2, gm_recombination_diffusion_crip_threshold_v2 = recombination_diffusion_crip_v2(
        gm_topD_dic_clean, gm_recombinations)
    print(1 + 1)
    ...
    # print(kclique_topD_dic_clean)
    # print(kclique_recombinations)

    kclique_recombination_diffusion_overlapping_count_v2, kclique_recombination_diffusion_overlapping_fraction_v2, kclique_recombination_diffusion_overlapping_threshold_v2 = recombination_diffusion_overlapping_v2(
        kclique_topD_dic_clean, kclique_recombinations)
    lais2_recombination_diffusion_overlapping_count_v2, lais2_recombination_diffusion_overlapping_fraction_v2, lais2_recombination_diffusion_overlapping_threshold_v2 = recombination_diffusion_overlapping_v2(
        lais2_topD_dic_clean, lais2_recombinations)
